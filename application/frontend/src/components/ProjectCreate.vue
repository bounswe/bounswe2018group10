<template>
  <div class="bg-grey">
    ...
    <b-container class="form-narrow pt-2">
          ...
          <b-form-row>
            <b-col>
              <b-form-group label-for="inputTitle">
                <template slot="label">
                  <font-awesome-icon icon="text-height" fixed-width/>Project Title
                </template>
                <b-form-input
                  id="inputTitle"
                  type="text"
          ...
          <b-form-row>
            <b-col>
              <b-form-group label-for="inputDesc">
                <template slot="label">
                  <font-awesome-icon icon="align-left" fixed-width/>Project Description
                </template>
          ...
          <b-form-row>
            <b-col>
              <b-form-group label-for="inputCategory">
                <template slot="label">
                  <font-awesome-icon icon="layer-group" fixed-width/>Category
                </template>
                <b-form-select
          ...
          <b-form-row>
            <b-col>
              <b-form-group label-for="inputMinBudget">
                <template slot="label">
                  <font-awesome-icon icon="money-bill" fixed-width/>Minimum Budget
                </template>
                <b-form-input
                  id="inputMinBudget"
                  type="number"
            ...
            <b-col>
              <b-form-group label-for="inputMaxBudget">
                <template slot="label">
                  <font-awesome-icon icon="money-bill" fixed-width/>Maximum Budget
                </template>
                <b-form-input
                  id="inputMaxBudget"
                  type="number"
          ...
          <b-form-row>
            <b-col>
              <b-form-group label-for="inputDeadlineD">
                <template slot="label">
                  <font-awesome-icon icon="calendar-alt" fixed-width/>Deadline Date
                </template>
                <b-form-input
                  id="inputDeadlineD"
                  type="date"
            ...
            <b-col>
              <b-form-group label-for="inputDeadlineT">
                <template slot="label">
                  <font-awesome-icon icon="clock" fixed-width/>Deadline Time
                </template>
                <b-form-input id="inputDeadlineT" type="time" v-model="form.deadlineTime" required></b-form-input>
              </b-form-group>
            </b-col>
          </b-form-row>
            ...
            <b-col>
              <b-form-group>
                ...
                <b-collapse id="collapse1">
                  <h6>
                    <font-awesome-icon icon="map-marker-alt" fixed-width/>Location
                    <span class="text-muted">(Optional)</span>
                  </h6>
                  <div>
                    <small
                      class="text-muted"
                    >You can select a location by clicking to the map or searching via search box. You can change the selected location by clicking again. You can remove location by reset button.</small>
                  </div>
